...
- **AVÍSAME** (a la usuaria) cada vez que el contexto se llene y sea necesario:
  1. Empezar una nueva conversación
  2. Compactar / resumir (lo que opencode llama "compact")
- La señal típica es que las respuestas se vuelvan lentas, se pierdan detalles, o el modelo diga "no recuerdo X".
- Antes de compactar: **guarda el estado en docs/** (bitácora, tareas, glosario) y haz commit. (hosting)
